...
import { Facebook, Twitter, Instagram, Copy, X } from 'lucide-react';
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="mb-1 text-center text-2xl font-bold text-gray-800 dark:text-white">Paylaş</h2>
            <p className="mb-6 text-center text-sm text-gray-500 dark:text-gray-400">
              Öğrenci Not Hesaplama aracını arkadaşlarınla paylaş
            </p>
            ...
            <div className="mb-6 grid grid-cols-3 gap-3">
              <motion.button 
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.95 }}
                className="flex flex-col items-center justify-center rounded-lg bg-blue-600 py-3 text-white shadow-md transition-colors hover:bg-blue-700"
              >
              ...
              <motion.button 
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.95 }}
                className="flex flex-col items-center justify-center rounded-lg bg-sky-500 py-3 text-white shadow-md transition-colors hover:bg-sky-600"
              >
              ...
              <motion.button 
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.95 }}
                className="flex flex-col items-center justify-center rounded-lg bg-pink-600 py-3 text-white shadow-md transition-colors hover:bg-pink-700"
              >
